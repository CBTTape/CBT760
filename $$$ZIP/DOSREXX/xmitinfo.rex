...
* ---------- ----------- ---------------------------------------------
* DGAlcock   2000-07-06  v1.1 Handle Regina Rexx;
...
say "Copyright 1998-2000 by David Alcock. All rights reserved."
say " "
...
if ebcdic == 0 then do
   inmr02_utiln = translate(inmr02_futiln,hextable,toEBCDIC)
   end
